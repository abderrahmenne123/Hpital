...
public class AdminController {
	...
	public AdminController(UserService userService,AdminServiceImplementation obj,
			AppointmentServiceImplementation app,DepartementServiceImplementation dep) {
		this.userService = userService;
		adminServiceImplementation=obj;
		appointmentServiceImplementation=app;
		departementServiceImplementation=dep;
	}
	...
	public String showFormForAdd(Model theModel) {
		...
		return "admin/addDoctor";//le nom des page html dans le dossier admin
	}
	...
	*/
    ...
    public String saveStudent(@ModelAttribute("dep") Departement std) {
        departementServiceImplementation.save(std);
        return "redirect:/admin/listedep";
    }
